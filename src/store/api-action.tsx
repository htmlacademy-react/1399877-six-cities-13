...
import { AuthorizedUser } from '../types/user-data-types';
import { AppDispatch, State } from '../types/state';
import { Offer, DetailOffer } from '../types/offers-types';
...
>(`${NameSpace.Reviews}/fetchReviews`, async (id, { extra: api }) => {
...
>(`${NameSpace.NearPlaces}/fetchNearPlaces`, async (id, { extra: api }) => {
...
export const postReview = createAsyncThunk<
  Review,
  { reviewData: ReviewData; id: Offer['id'] },
  {
    dispatch: AppDispatch;
    state: State;
    extra: AxiosInstance;
